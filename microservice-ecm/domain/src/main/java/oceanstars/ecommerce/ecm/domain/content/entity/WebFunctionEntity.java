 ...
 */
public class WebFunctionEntity extends Entity<WebFunctionIdentifier> {
   ...
   * @param builder 构建器
   */
  private WebFunctionEntity(Builder builder) {
  ...
  public static final class Builder {
    ...
    public WebFunctionEntity build() {
      return new WebFunctionEntity(this);
    }
  }
}
