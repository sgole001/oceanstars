package oceanstars.ecommerce.ecm.controller.v1.tag.restful.handle;
...
public class CreateTagRestHandler extends BaseRestHandler<CreateTagRequestMessage> {
   ...
   */
  public CreateTagRestHandler(Bus cqrsGateway) {
  ...
  public RestResponseMessage packageResponseMessage(GeneratedMessageV3 result) {
    ...
    // 获取创建内容命令处理结果
    final EcmCreateTagResult createTagResult = (EcmCreateTagResult) result;
