 ...
 */
@Component
public class GetCategoryRestHandler extends BaseRestHandler<GetCategoryRequestMessage> {
   ...
   */
  public GetCategoryRestHandler(Bus cqrsGateway) {
    this.cqrsGateway = cqrsGateway;
  }

  @Override
  public GeneratedMessageV3[] parsingRequestMessage(GetCategoryRequestMessage restRequestMessage) {
