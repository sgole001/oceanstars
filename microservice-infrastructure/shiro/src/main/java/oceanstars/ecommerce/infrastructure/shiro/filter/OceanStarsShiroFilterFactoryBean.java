 ...
 */
public class OceanStarsShiroFilterFactoryBean extends ShiroFilterFactoryBean {

  /**
   * 日志管理器
   */
  private final Logger logger = LogManager.getLogger(OceanStarsShiroFilterFactoryBean.class.getName());

  /**
   * 默认构造器
   */
  public OceanStarsShiroFilterFactoryBean() {
    // 初始化全局拦截器
