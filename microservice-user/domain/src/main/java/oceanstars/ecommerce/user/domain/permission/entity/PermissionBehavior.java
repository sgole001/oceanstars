 ...
 */
public class PermissionBehavior extends Entity<PermissionBehaviorIdentifier> {
   ...
   * @param builder 构建器
   */
  private PermissionBehavior(Builder builder) {
    super(new PermissionBehaviorIdentifier(builder.permission, builder.resource));
   ...
   * @return 权限操作值对象构建器
   */
  public static PermissionBehavior.Builder newBuilder(final Permission permission, final Long resource) {
    return new PermissionBehavior.Builder(permission, resource);
  }
  ...
  public static final class Builder {
    ...
    public Builder(Permission permission, Long resource) {
    ...
    public PermissionBehavior build() {
      return new PermissionBehavior(this);
    }
  }
}
