...
public class RelRolePermissionPojo implements IRelRolePermission {
    ...
    public RelRolePermissionPojo() {}

    public RelRolePermissionPojo(IRelRolePermission value) {
        this.id = value.getId();
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final RelRolePermissionPojo other = (RelRolePermissionPojo) obj;
        if (this.id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("RelRolePermissionPojo (");
